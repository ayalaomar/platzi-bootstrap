               ...
               <div class="container">
                    <div class="row d-flex align-items-center h-100">
                        <div class="col-md-6 offset-md-6 text-center text-md-end">
                            ...
                            <p class="d-none d-md-block">Platzi Conf llega por primera vez a Hawaii! Un evento para compartir con nuestra comunidad el conocimiento y experiencia de los expertos
                                 que están creando el futuro del Internet. Ven a conocer a miembros del Team Platzi, a otros estudiantes de Platzi y a los oradores de 
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-4 mb-4 ">
                <div class="card ">
                    ...
                    <div class="card-body">
                    <div class="badges d-flex justify-content-end mb-2">
                        <span class="badge bg-warning">JavaScript</span>
                        <span class="badge bg-primary">React</span>
                    </div>
                      <h5 class="card-title ">Sacha Lifszyc</h5>
                      
                      <p class="card-text">Aenean vel risus odio. Sed mattis lectus in pulvinar accumsan.
                         Nullam elit neque, suscipit quis aliquam et, malesuada quis justo. </p>
                    </div>
                  </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                <div class="card">
                    ...
                    <div class="badges d-flex justify-content-end mb-2">
                      ...
                      <p class="card-text">Morbi pretium sapien posuere, rhoncus diam sed, aliquet libero.
                         Vestibulum laoreet, nulla et viverra dignissim, elit tortor vulputate risus, non. </p>
                    </div>
                  </div>
            </div>
            <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                    <div class="badges d-flex justify-content-end mb-2">
                        <span class="badge bg-warning">Programmer</span>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                <div class="card">
                    <img src="assets/speakers/cvander.jpeg" class="card-img-top" alt="Foto de cristian">
                    <div class="badges d-flex  ms-auto p-2">
                        <span class="badge bg-warning">Startups</span>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-lg-6  pt-2 pb-4">
               ...
               en los Estados Unidos.nota  Honolulu es la más sureña de entre las principales ciudades estadounidenses. 
               Aunque el nombre de Honolulu se refiere al área urbana en la costa sureste de la isla de Oahu, la ciudad y 
               el condado de Honolulu han formado una ciudad-condado consolidada que cubre toda la isla (aproximadamente 600 km² de superficie).
               </p>
...
<section id="conviertete-en-orador" class="pt-2 pb-2">
	<div class="container">
		...
		<div class="row">
			<div class="col text-center orador">
				Anótate como orador para dar una charla 
                <abbr title="Charlas de 5 minutos" data-bs-toggle="tooltip">ignite.</abbr> Cuéntanos de qué
				quieres hablar!
			</div>
		</div>
		<div class="row">
